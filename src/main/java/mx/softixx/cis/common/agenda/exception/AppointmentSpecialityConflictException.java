...
public class AppointmentSpecialityConflictException extends CustomException {

	public AppointmentSpecialityConflictException() {
		super(MessageUtils.getMessage("exception.text.conflict.appointment.speciality"),
