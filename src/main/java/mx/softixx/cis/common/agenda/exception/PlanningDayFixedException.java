...
public class PlanningDayFixedException extends CustomException {

	public PlanningDayFixedException() {
		super(MessageUtils.getMessage("exception.text.invalid.planning.day"),
